  ...
  useAOSInit()
    return (
      <Element name="Gelary" className="element">
        ...
        <div data-aos="zoom-in-down" data-aos-duration="1100" className="grid  grid-cols-4 gap-4 w-full ">
        ...
        <div data-aos="zoom-in-down" className="grid  grid-cols-3 gap-4  mt-4">
