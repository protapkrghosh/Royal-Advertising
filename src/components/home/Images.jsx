  ...
  useAOSInit()
    return (
      <Element name="Gallery" className="element">
        ...
        <div data-aos="zoom-in-down" data-aos-duration="3000" className="grid  grid-cols-4 gap-4 w-full ">
        ...
        <div data-aos="zoom-in-down" data-aos-duration="3000" className="grid  grid-cols-3 gap-4  mt-4">
        ...
        <div data-aos="zoom-in-down" className="grid grid-cols-4 gap-4  mt-4">
