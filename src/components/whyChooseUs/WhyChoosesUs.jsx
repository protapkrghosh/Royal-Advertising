...
const WhyChoosesUs = () => {
  ...
  return (
    <div className="py-5 md:py-24" style={imgeStyle}>
      <h1 data-aos="fade-up" data-aos-duration="2000" className="text-primary  mb-7 text-center">Why Choose Us</h1>
      <div data-aos="fade-down-left" data-aos-duration="2000"  className="grid grid-cols-1 md:grid-cols-2  md:w-9/12 mx-auto pt-14">
        {whyChooseUsData.map((chooseus, index) => (
          <div key={index} className="card w-full ">           
            <figure><img src={chooseus.imge} alt="choosus" loading="lazy" className="w-20 h-20 rounded-full" /></figure>
