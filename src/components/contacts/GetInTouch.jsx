      ...
      <div data-aos="fade-left" data-aos-duration="3000" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-12 gap-10">
        ...
        <div data-testid="email-icon"  className="text-center">
          <div className="flex justify-center">
            <img src="https://reflectivedesign.in/wp-content/uploads/2023/03/email.png" loading='lazy' alt="Email Icon" />
          </div>
        ...
        <div className="text-center relative">
          <div className="flex justify-center">
            <img src="https://reflectivedesign.in/wp-content/uploads/2021/11/map.svg" loading='lazy' alt="Address Icon" />
          </div>
        ...
        <div data-testid="telephone-icon" className="text-center">
          <div className="flex justify-center">
            <img src="https://reflectivedesign.in/wp-content/uploads/2021/11/telephone.svg" loading='lazy' alt="Telephone Icon" />
          </div>
